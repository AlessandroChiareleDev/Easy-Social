"""
Envio Lote 2 Maio/2025 APPA — Complementar (410 CPFs).
Inspirado em envio_lote2_outubro.py, com paralelismo controlado.
"""
...
BATCH_SIZE = 30
TIMEOUT    = 600
OUTDIR     = os.path.join(ROOT, "saida_lote2_maio_complementar")
