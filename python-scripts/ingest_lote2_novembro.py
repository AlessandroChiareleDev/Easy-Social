"""
Ingestao Lote 2 Novembro/2025 — popula s1210_cpf_scope + s1210_operadoras.

XLSX: 11 Novembro_lote 002_APPA.xlsx
  857 linhas, todos '2º Lote'
...
XLSX_PATH  = Path(r"C:\Users\xandao\Downloads\11 Novembro_lote 002_APPA.xlsx")
...
def main() -> int:
    ...
    for idx, row in enumerate(it, start=2):
        ...
        # col 0 = Lotes ("2º Lote") — extrai digito
    ...
    try:
        with conn.cursor() as cur:
            ...
            print("[check scope 2025-11]", cur.fetchall())
            cur.execute(
            ...
            print("[check operadoras 2025-11]", cur.fetchall())
    finally:
        conn.close()
