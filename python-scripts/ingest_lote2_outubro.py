"""
Ingestao Lote 2 Outubro/2025 — popula s1210_cpf_scope + s1210_operadoras.

XLSX: 10 Outubro_lote 002_APPA.xlsx
  1066 linhas
...
Regras planSaude:
  ...
  - Agrupa por (cpf, cnpj_operadora, rubrica) para auditoria
"""
...
XLSX_PATH  = Path(r"C:\Users\xandao\Downloads\10 Outubro_lote 002_APPA.xlsx")
ABA_GERAL  = "Lote para Envio"
ABA_OPER   = "Assistencia Medica"
PER_APUR   = "2025-10"
EMPRESA_ID = 1
LOTE_ALVO  = 2
...
def main() -> int:
    ...
    if ABA_GERAL not in wb.sheetnames:
        print(f"[ERR] aba '{ABA_GERAL}' nao encontrada. Abas disponíveis: {wb.sheetnames}")
        return 3
    ...
    for idx, row in enumerate(it, start=2):
        ...
        # (empresa_id, per_apur, cpf, nome, matricula, lote_num, row_number, raw_row)
    ...
    try:
        with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
            ...
            # Limpa scope lote 2 anterior (preserva outros lotes)
            cur.execute(
        ...
        with conn.cursor() as cur:
            ...
            print("[check scope 2025-10]", cur.fetchall())
            cur.execute(
            ...
            print("[check operadoras 2025-10]", cur.fetchall())
